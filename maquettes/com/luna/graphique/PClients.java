...
public class PClients extends JPanel {
	...
	public PClients() {
		...
		panel.setFocusTraversalPolicy(new FocusTraversalOnArray(new Component[]{lblClients, btnAjouter, btnRechercher, btnModifier, btnSupprimer, btnAperu, btnImprimer, btnExporter, btnAcceuil}));
					...
					.addGroup(gl_panel_1.createParallelGroup(Alignment.TRAILING)
						...
						.addGroup(Alignment.LEADING, gl_panel_1.createParallelGroup(Alignment.TRAILING, false)
							...
							.addGroup(Alignment.LEADING, gl_panel_1.createSequentialGroup()
								.addComponent(lblTrierLaListe, GroupLayout.PREFERRED_SIZE, 100, GroupLayout.PREFERRED_SIZE)
								.addGap(2)
		...
		gl_panel_1.setVerticalGroup(
			gl_panel_1.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel_1.createSequentialGroup()
					.addContainerGap()
					.addComponent(panel_2, GroupLayout.PREFERRED_SIZE, 246, GroupLayout.PREFERRED_SIZE)
					...
					.addGroup(gl_panel_1.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_panel_1.createSequentialGroup()
							.addGap(3)
							.addComponent(lblTrierLaListe, GroupLayout.PREFERRED_SIZE, 14, GroupLayout.PREFERRED_SIZE))
						.addComponent(comboBox, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)))
		);
		panel_1.setLayout(gl_panel_1);
		panel_1.setFocusTraversalPolicy(new FocusTraversalOnArray(new Component[]{panel_2, label_1, textField, lblCodeClient, textField_1, textField_2, lblRemarques, lblRue, textField_3, lblTel, textField_4, lblVille, label_7, textField_5, textField_6, label_8, textField_7, label_9, textField_8, textField_9, lblPrnom, scrollPane, lblTrierLaListe, comboBox}));
