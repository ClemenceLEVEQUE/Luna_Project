...
public class FConnect extends JFrame {
	...
	public FConnect() {
		...
		setIconImage(Toolkit.getDefaultToolkit()
				.getImage(FConnect.class.getResource("/com/luna/graphique/Moon-32.png")));
						...
						login.setColumns(10);
										...
										lblUser.setFont(new Font("Tahoma", Font.PLAIN, 13));
												...
												lblPassword.setFont(new Font("Tahoma", Font.PLAIN, 13));
														...
														JLabel lblVeuillezSaisir = new JLabel("<html>Veuillez saisir le nom d'utilisateur ainsi que le mot de passe associ\u00E9 \u00E0 ce dernier afin d'acc\u00E8der \u00E0 l'application.</html>");
